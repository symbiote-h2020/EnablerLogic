...
public class EnablerSpecificPlatformPlugin extends PlatformPlugin {
    ...
    public EnablerSpecificPlatformPlugin(RabbitManager rabbitManager) {
        super(rabbitManager, PLUGIN_PLATFORM_ID, PLUGIN_PLATFORM_FILTERS_FLAG, 
                PLUGIN_PLATFORM_NOTIFICATIONS_FLAG);
    }
